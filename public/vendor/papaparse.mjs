...
// .vendor-entrypoints-tmp/papaparse.mjs.entry.mjs
var import_papaparse = __toESM(require_papaparse_min(), 1);
var papaparse_mjs_entry_default = import_papaparse.default;
var { parse, unparse } = import_papaparse.default;
export {
  papaparse_mjs_entry_default as default,
  parse,
  unparse
};
